...
- Benchmark tests use their package-local Python and Node dependencies. The source-check workflow runs capability tests and a smoke measurement, with timing thresholds reserved for controlled hosts.
