...
Run the complete local gate with `make check`. It validates the release contract, Python and Rust formatting, lint, types, tests, the Rust 1.85 floor, and all three distributions.
